...
?>
	<div id="sidebar-pagebottom" class="sidebar-pagebottom">
		...
		<div class="container">
		<h2 class="widget-title"><?php _e( 'Ready to join the fun?', 'flat-bootstrap' ); ?></h2>
		<div class="textwidget">
		<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
		<p><?php _e( "Sign up free today!", 'flat-bootstrap' ); ?></p>
		<p><button type="button" class="btn btn-hollow btn-lg"><?php _e( 'Join Now!', 'flat-bootstrap' ); ?></button></p>
		</div><!-- col-lg-8 -->
		</div><!-- row -->
		</div><!-- textwidget -->
		</div><!-- container -->
